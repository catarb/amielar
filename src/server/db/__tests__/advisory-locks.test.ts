...
describe("advisory locks de disponibilidad", () => {
  it("ordena y deduplica los horarios antes de adquirirlos", async () => {
    ...
    await acquireSlotAdvisoryLocks(tx, "aire-de-colmena", [new Date("2026-12-15T21:00:00.000Z"), new Date("2026-12-15T18:00:00.000Z"), new Date("2026-12-15T21:00:00.000Z")]);
