  ...
  return (
    <div className="mx-auto w-full max-w-none space-y-4">
      {items.map((item) => (
        <details
          key={item.question}
          className="group card-shell flex w-full max-w-none flex-col justify-center overflow-hidden px-8 py-6 shadow-[0_12px_28px_rgba(67,59,38,0.06)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_16px_34px_rgba(67,59,38,0.09)] open:bg-[rgba(255,255,255,0.94)] md:min-h-0 md:px-6 md:py-5"
        >
