...
export function ProductCard({ name, description, image, imagePosition, className = "" }: ProductCardProps) {
  return (
    <article
      className={`card-shell group flex h-full flex-col overflow-hidden rounded-[2.05rem] bg-[linear-gradient(180deg,rgba(255,255,255,0.94),rgba(251,248,241,0.98))] shadow-[0_12px_28px_rgba(67,59,38,0.06)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_18px_36px_rgba(67,59,38,0.1)] ${className}`}
    >
