      ...
      {items.map((item, index) => {
        ...
        return (
          <article
            ...
            className={`group relative h-full min-h-[180px] overflow-hidden rounded-[32px] border border-[rgba(67,59,38,0.1)] shadow-[0_14px_32px_rgba(67,59,38,0.07)] transition-all duration-300 ease-out hover:-translate-y-1 hover:shadow-[0_18px_40px_rgba(67,59,38,0.1)] md:min-h-0 ${spanClass}`}
          >
            <Image
              src={item.image}
              alt={item.title}
