...
const links = [
  { id: "los-comienzos", label: "Los comienzos" },
  { id: "el-legado", label: "El legado" },
  { id: "nace-amielar", label: "Nace AMIELAR" },
  { id: "hoy", label: "Hoy" },
] as const;
    ...
    <>
      ...
      >
        ...
        >
          ...
          <InternalHeaderActions homeHref="/" />
          ...
          <button
            ...
            aria-label={open ? "Cerrar menú de Nuestra Historia" : "Abrir menú de Nuestra Historia"}
            aria-expanded={open}
            aria-controls="history-page-mobile-menu"
          >
        ...
        <div
          ...
          aria-hidden={!open}
        >
          <nav aria-label="Capítulos de Nuestra Historia" className="flex flex-col gap-1">
            {links.map(({ id, label }) => {
              const isActive = activeId === id;
          ...
          <InternalHeaderActions homeHref="/" mobile onNavigate={() => closeMenu()} />
        </div>
      </header>
